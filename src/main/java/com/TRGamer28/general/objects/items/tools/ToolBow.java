...
public class ToolBow extends Item implements IHasModel
{
	...
	//example usage (standard bow values) maxDurability -> 384, enchantability -> 1, maxArrowVelocity -> 1.0f, chargeSpeedMod -> 1.0f, accuracy
	
	public ToolBow(String name, int maxDurability, int enchantability, float maxArrowVelocity, float chargeSpeedMod, float dmgMod, float accuracy) 
	{
	...
	public ToolBow(String name, ToolMaterial material)
    {
        ...
        this.maxStackSize = 1;
        this.setMaxDamage( (int)material.getMaxUses()); //sets durability
        this.enchantability = material.getEnchantability();
        this.chargeSpeedMod = (float) 1.0;
        this.maxArrowVelocity = (float) 1.0;
        this.dmgMod = (material.getAttackDamage()/2) + 1.0f;
        this.inaccuracy = 1;
        construct(name);
    }
    ...
    public static float getArrowVelocity(int charge)
    {
        ...
        f = chargeSpeedMod * (f * f + f * 2.0F) / 3.0F;
